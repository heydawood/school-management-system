...
import { AVATAR_KEY, FORGOT_EMAIL_KEY, FORGOT_OTP_KEY, TOKEN_KEY, USER_ID_KEY, USER_NAME_KEY } from '@/Utils/Constants';
...
export const { setToken, removeToken, setUserInfo, setEmail, setOtp, clearForgotFlow } = authSlice.actions;
