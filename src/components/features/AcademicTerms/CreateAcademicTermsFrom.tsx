...
import Input from '@/components/ui/input/input';
import {
  CreateAcademicTermDefaultValues,
  type CreateAcademicTermTypes,
} from '@/Forms/CreateAcademicTermTypes';
import { useCreateAcademicTerm } from '@/Hooks/TanStack/AcademicTerms/useCreateAcademicTerm';

const CreateAcademicTermsForm = () => {
  const navigate = useNavigate();

  const form = useForm<CreateAcademicTermTypes>({
    defaultValues: CreateAcademicTermDefaultValues,
    mode: 'onChange',
  });
  ...
  const onSubmit = (data: CreateAcademicTermTypes) => {
    createMutation.mutate(data, {
      onSuccess: () => {
        ...
        navigate('/dashboard/academic-terms');
      },
    });
  };
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="mb-6">
                <Input
                  ...
                  name="name"
                  rules={{
                    required: 'Academic Term Name is required',
                    minLength: {
                      value: 3,
...
export default CreateAcademicTermsForm;
