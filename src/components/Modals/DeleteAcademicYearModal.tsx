...
const DeleteAcademicYearModal: FC<Props> = ({ close, onDelete, deleting }) => {
  ...
  return (
            <Modal classNames="md:max-w-[40%]" closeModal={close}>
                <Fragment>
                    ...
                    >
                        <div>
                            <h1 className="text-heading font-semibold">Delete Academic Year</h1>
                            <p className="text-paragraph text-gray-500">Are you sure you want to delete this academic year? This action cannot be undone.</p>
                        </div>
                    </Modalheader>
