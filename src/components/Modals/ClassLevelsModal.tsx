...
const ClassLevelsModal: FC<Props> = ({ close, classLevelsId }) => {
    ...
    <>
      <Modal classNames={`md:max-w-[40%] md:min-w-[40%] h-fit overflow-x-auto scrollbar-thin`} closeModal={close}>
        <Fragment>
          ...
          >
            <div>
              <h1 className="text-heading font-semibold">Class Level Details</h1>
              <p className="text-paragraph text-gray-500">Here you can see the details of the selected Class Level.</p>
            </div>
          </Modalheader>
                    ...
                    {data && (
                      <div className="grid grid-cols-2 gap-4 text-sm mt-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-paragraph">{data._id}</span>
                        </div>
...
export default ClassLevelsModal
