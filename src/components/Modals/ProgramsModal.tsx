    ...
    <>
      <Modal classNames={`md:max-w-[40%] md:min-w-[40%] h-fit overflow-x-auto scrollbar-thin`} closeModal={close}>
        <Fragment>
          ...
          >
            <div>
              <h1 className="text-heading font-semibold">Programs Details</h1>
              <p className="text-paragraph text-gray-500">Here you can see the details of the selected Programs.</p>
            </div>
          </Modalheader>
                  ...
                  <div className="after:absolute after:inset-y-0 after:w-px after:bg-gray-500/20 relative pl-6 after:left-0 grid dark:after:bg-gray-400/20">
                    ...
                    {data && (
                      <div className="grid grid-cols-2 gap-4 text-sm mt-4">
                        ...
                        <div className="flex flex-col">
                          <span className="text-gray-500 text-xs">Subject Code</span>
                          <span className="text-paragraph">
                            {data.code}
                          </span>
                        </div>
